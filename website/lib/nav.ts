...
export const NAV_PT: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Redes (Networks)', slug: ['modules', 'networks'] },
      { title: 'Stablecoins (USDC/EURC)', slug: ['modules', 'stablecoins'] },
      { title: 'Fees & Paymaster', slug: ['modules', 'fees-paymaster'] },
      { title: 'CCTP Bridge', slug: ['modules', 'bridge'] },
      { title: 'Economia Agêntica', slug: ['modules', 'agent-economy'] },
      { title: 'MCP Server', slug: ['modules', 'mcp-server'] },
      { title: 'Price Oracle', slug: ['modules', 'oracle'] },
      { title: 'Signer Plugável', slug: ['modules', 'signer'] },
      { title: 'Privacidade', slug: ['modules', 'privacy'] },
    ],
  },
  {
    section: 'Interfaces',
...
export const NAV_EN: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Event Listener', slug: ['modules', 'event-listener'] },
      { title: 'Contract Deployer', slug: ['modules', 'contract-deployer'] },
      { title: 'Networks', slug: ['modules', 'networks'] },
      { title: 'Stablecoins (USDC/EURC)', slug: ['modules', 'stablecoins'] },
      { title: 'Fees & Paymaster', slug: ['modules', 'fees-paymaster'] },
      { title: 'CCTP Bridge', slug: ['modules', 'bridge'] },
      { title: 'Agentic Economy', slug: ['modules', 'agent-economy'] },
      { title: 'MCP Server', slug: ['modules', 'mcp-server'] },
      { title: 'Price Oracle', slug: ['modules', 'oracle'] },
      { title: 'Pluggable Signer', slug: ['modules', 'signer'] },
      { title: 'Privacy', slug: ['modules', 'privacy'] },
    ],
  },
  {
    section: 'Interfaces',
